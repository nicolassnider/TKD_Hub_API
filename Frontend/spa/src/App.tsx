...
export default function App() {
  ...
  <main className="app-container p-4">
          <Routes>
            <Route path="/" element={<div className="min-h-[60vh] flex items-center justify-center"><h1 className="text-3xl font-bold">Welcome to TKD Hub</h1></div>} />
            ...
            <Route path="/payments/mercadopago" element={<MercadoPagoDebug/>} />
          </Routes>
        </main>
      </BrowserRouter>
    </RoleProvider>
