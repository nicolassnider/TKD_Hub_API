                ...
                {isServicesOpen && (
                  <div className="absolute left-0 mt-2 w-48 bg-gray-700 rounded-md shadow-lg z-10">
                    ...
                    <Link
                      ...
                      onClick={e => {
                        e.preventDefault();
                        router.push("/dojaangsAdmin");
                        setIsServicesOpen(false);
                      }}
                    >
                      <i className="bi bi-house-fill mr-2"></i> Dojangs
                    </Link>
                    <Link href="/users" className="block px-4 py-2 hover:bg-gray-600">
            ...
            <div className="relative">
              ...
              {isServicesOpen && (
                <div className="absolute left-0 mt-2 w-full bg-gray-700 rounded-md shadow-lg z-10">
                  ...
                  <Link href="/dojangs" className="block px-4 py-2 hover:bg-gray-600">
                    <i className="bi bi-house-fill mr-2"></i> Dojangs
                  </Link>
                  <Link href="/users" className="block px-4 py-2 hover:bg-gray-600">
                    <i className="bi bi-people-fill mr-2"></i> Users
