...
export default function EditPromotion({
  ...
  const [originalPromotion, setOriginalPromotion] =
    useState<Partial<Promotion> | null>(promotion ? { ...promotion } : null);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg max-h-[90vh] flex flex-col relative overflow-y-auto">
        <ModalCloseButton
        ...
        {promotionsError && (
          <div className="text-red-600 text-center mb-2">{promotionsError}</div>
        )}
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <GenericSelector
                ...
                label="Rank"
                placeholder={
                  loadingRanks ? "Loading ranks..." : "Select a rank"
                }
              />
              {/* Coach selector */}
              <GenericSelector
              ...
              <LabeledInput
                ...
                datepicker
                selectedDate={
                  formState.promotionDate
                    ? new Date(formState.promotionDate)
                    : null
                }
                onDateChange={(date) =>
                  setFormState((prev) => ({
