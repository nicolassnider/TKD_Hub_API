...
type CoachClassesProps = {
    loading: boolean;
    coachClasses: CoachClass[] | null;
};

const CoachClasses: React.FC<CoachClassesProps> = ({ loading, coachClasses }) => (
    <div className="mt-8">
        <h3 className="text-2xl font-bold mb-4 text-blue-700">Classes I Give</h3>
        {loading && (
