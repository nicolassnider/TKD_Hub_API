    ...
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} md={4}>
          <Card
            sx={{
              bgcolor: overduePayments.length > 0 ? "error.50" : "success.50",
            }}
          >
            <CardContent sx={{ textAlign: "center" }}>
              <PaymentIcon
                sx={{
                  fontSize: 40,
                  color:
                    overduePayments.length > 0 ? "error.main" : "success.main",
                  mb: 1,
                }}
              />
              <Typography
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            disabled={
              !paymentForm.amount || !paymentForm.description || loading
            }
            startIcon={<CreditCardIcon />}
          >
