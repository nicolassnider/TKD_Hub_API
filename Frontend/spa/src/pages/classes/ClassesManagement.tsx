...
function ClassesTable() {
  ...
  // Note: ClassForm handles submission internally via ClassContext
    ...
    <div>
      ...
      <ClassForm
        ...
        onClose={() => {
          setFormOpen(false);
          setEditingClass(null);
          reload(); // Reload the table after closing the form
        }}
        trainingClass={editingClass as any} // Type conversion needed due to API/local type differences
